...
#include "Crosshair/FPSTemplate_CrosshairWidget.h"
...
UFPSTemplate_CrosshairWidget::UFPSTemplate_CrosshairWidget(const FObjectInitializer& ObjectInitializer)
...
void UFPSTemplate_CrosshairWidget::SynchronizeProperties()
{
...
void UFPSTemplate_CrosshairWidget::NativeConstruct()
{
	...
	{
		GetWorld()->GetTimerManager().SetTimer(TCrosshair, this, &UFPSTemplate_CrosshairWidget::HandleCrosshairOffset, 1.0f / UpdatesPerSecond, true);
	}
}

void UFPSTemplate_CrosshairWidget::SetCanvasPanelSlots()
{
...
UCanvasPanelSlot* UFPSTemplate_CrosshairWidget::GetCanvasPanelSlot(UWidget* Widget) const
{
	if (Widget)
	{
...
void UFPSTemplate_CrosshairWidget::HandleCrosshairOffset()
{
	if (OwningPawn)
	{
...
void UFPSTemplate_CrosshairWidget::HandleCrosshairOffset(float Velocity)
{
